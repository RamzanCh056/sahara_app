                            ...
                            children: [
                              Text(
                                ...
                                style: AppTextStyles.regularStyle.copyWith(
                                    color: AppColors.primaryWhite, fontSize: 14),
                              ),
                              Text(
                                'Momin Hassan',
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        return GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Image(
                                image: AssetImage(logosList[index].toString()),
                              ),
                              Text(
                                logosName[index].toString(),
                                style: AppTextStyles.boldStyle.copyWith(
                                    color: const Color(0xff27324A), fontSize: 16),
                              ),
                            ],
                          ),
                        );
                    ...
                    GestureDetector(
                      ...
                      onTap: (){
Navigator.push(context, MaterialPageRoute(builder: (context)=>QurranChoiceSelect()));
                      },
