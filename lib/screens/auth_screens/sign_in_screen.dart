                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        'or',
                        style: AppTextStyles.semiBoldStyle.copyWith(
                            color: const Color(0xff7D8CAC), fontSize: 14),
                      ),
                      const SizedBox(width: 15),
                      Expanded(
                          child: Divider(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: const Image(
                              image: AssetImage(
                                  'assets/images/auth_screen/Group 18559.png')),
                        ),
                        Container(
                          padding: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
                          ...
                          child: const Image(
                              image: AssetImage(
                                  'assets/images/auth_screen/Group 18557.png')),
                        ),
                        Container(
                          padding: const EdgeInsets.all(10),
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: const Color(0xffEEF1F7))),
                          child: const Image(
                              image: AssetImage('assets/images/auth_screen/Shape.png')),
                        ),
                      ],
                    ),
                  ),
